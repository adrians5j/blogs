...
The workflow is simple: I describe what I need, and OpenCode handles the mechanical parts while keeping me in the loop. No more copy-paste. No more manual file navigation. Just natural language requests and actual results.
...
Is this overkill for most tasks? Absolutely. But when you need it, it's incredibly powerful.

## 3. Storm's Pull Request Interface
...
I use Storm's PR interface specifically because it makes commenting on AI-generated code feel natural. The code is right there, I can leave inline comments on specific lines, request changes, and the AI can respond to my feedback directly in the PR.

The workflow looks like this: AI opens a PR with the generated code, I review it (usually on my desktop, but sometimes on GitHub's mobile app when I'm on the go), leave comments on anything that needs adjustment, and the AI iterates based on my feedback. Once I'm happy, I approve and merge.
