...
When OpenCode makes changes, I don't usually look at the diffs it shows in the CLI. Instead, I switch to WebStorm's Commit tab to review changes using the IDE's diff viewer. It's just much easier to see what actually changed with proper syntax highlighting and side-by-side comparison.

<!-- TODO: Add screenshot of WebStorm's diff viewer showing changes between files -->
